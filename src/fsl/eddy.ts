...
interface EddyParameters {
    "__STYXTYPE__": "eddy";
    "implementation": "" | "_openmp" | "_cuda" | "_cuda10.2" | "_cuda9.1" | "_cuda8.0";
    "imain": InputPathType;
    "mask": InputPathType;
    "index": InputPathType;
    "acqp": InputPathType;
...
function eddy_params(
     ...
     * @param implementation Choose the implementation to use
...
function eddy_cargs(
     ...
     */
    const cargs: string[] = [];
    cargs.push(["eddy", (params["implementation"] ?? null)].join(''));
