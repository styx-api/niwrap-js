...
const TCKGEN_METADATA: Metadata = {
    id: "14b8283e2f566ed63503a0f4d3dae99649fc54d2.boutiques",
    name: "tckgen",
    package: "mrtrix",
...
function tckgen_seed_image_params(
     ...
     */
    const params = {
        "__STYXTYPE__": "seed_image" as const,
        "image": image,
    };
    return params;
}
...
function tckgen_seed_sphere_params(
     ...
     */
    const params = {
        "__STYXTYPE__": "seed_sphere" as const,
        "spec": spec,
    };
    return params;
}
...
function tckgen_seed_random_per_voxel_params(
     ...
     */
    const params = {
        "__STYXTYPE__": "seed_random_per_voxel" as const,
        "image": image,
...
function tckgen_seed_grid_per_voxel_params(
     ...
     */
    const params = {
        "__STYXTYPE__": "seed_grid_per_voxel" as const,
        "image": image,
        "grid_size": grid_size,
    };
    return params;
...
function tckgen_seed_rejection_params(
     ...
     */
    const params = {
        "__STYXTYPE__": "seed_rejection" as const,
        "image": image,
    };
    return params;
}
...
function tckgen_seed_gmwmi_params(
     ...
     */
    const params = {
        "__STYXTYPE__": "seed_gmwmi" as const,
        "image": image,
    };
    return params;
}
...
function tckgen_cargs(
    ...
    if ((params["seed_image"] ?? null) !== null) {
        cargs.push(...(params["seed_image"] ?? null).map(s => dynCargs(s.__STYXTYPE__)(s, execution)).flat());
    }
    if ((params["seed_sphere"] ?? null) !== null) {
        cargs.push(...(params["seed_sphere"] ?? null).map(s => dynCargs(s.__STYXTYPE__)(s, execution)).flat());
    }
    if ((params["seed_random_per_voxel"] ?? null) !== null) {
        cargs.push(...(params["seed_random_per_voxel"] ?? null).map(s => dynCargs(s.__STYXTYPE__)(s, execution)).flat());
    }
    if ((params["seed_grid_per_voxel"] ?? null) !== null) {
        cargs.push(...(params["seed_grid_per_voxel"] ?? null).map(s => dynCargs(s.__STYXTYPE__)(s, execution)).flat());
    }
    if ((params["seed_rejection"] ?? null) !== null) {
        cargs.push(...(params["seed_rejection"] ?? null).map(s => dynCargs(s.__STYXTYPE__)(s, execution)).flat());
    }
    if ((params["seed_gmwmi"] ?? null) !== null) {
        cargs.push(...(params["seed_gmwmi"] ?? null).map(s => dynCargs(s.__STYXTYPE__)(s, execution)).flat());
    }
