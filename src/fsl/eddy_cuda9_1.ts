...
const EDDY_CUDA9_1_METADATA: Metadata = {
...
function eddy_cuda9_1_params(
     ...
     */
    const params = {
        "__STYXTYPE__": "eddy_cuda9.1" as const,
        "imain": imain,
        "mask": mask,
        "index": index,
        "acqp": acqp,
