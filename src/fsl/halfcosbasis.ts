...
function halfcosbasis(
    ...
    const params = halfcosbasis_params(hrf_param_file_hf, verbose_flag, debug_level_debuglevel, timing_on_flag, log_dir_logdir, num_hrf_samples, num_hrf_basis_funcs, num_secs_nsecs, temp_res)
