...
function metric_resample(
    ...
    const params = metric_resample_params(metric_in, current_sphere, new_sphere, method, metric_out, area_surfs, area_metrics, valid_roi_out, roi_metric, bypass_sphere_check, largest)
