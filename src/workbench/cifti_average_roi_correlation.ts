...
function cifti_average_roi_correlation(
    ...
    const params = cifti_average_roi_correlation_params(cifti_out, cifti_roi, cifti, cerebellum_surf, right_surf, left_surf, roi_vol, roi_metric, roi_metric_, roi_metric_2)
