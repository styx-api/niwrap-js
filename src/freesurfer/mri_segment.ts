...
const MRI_SEGMENT_METADATA: Metadata = {
    id: "a0c20f56e2e971cbda93e4d526f4cfbf192d2549.boutiques",
    name: "mri_segment",
    package: "freesurfer",
...
function mri_segment_params(
    ...
    pslope: number | null = 1.0,
    nslope: number | null = 1.0,
    debug_voxel: Array<number> | null = null,
    auto: boolean = false,
    noauto: boolean = false,
    log: boolean = false,
    keep: boolean = false,
    gray_hi: number | null = 100.0,
    wm_low: number | null = 80.0,
    wm_low_factor: number | null = null,
    wm_hi: number | null = 125.0,
    nseg: number | null = 20,
    thicken: boolean = false,
    fillbg: boolean = false,
    fillv: boolean = false,
    blur_sigma: number | null = 0.25,
    iterations: number | null = 1,
    thin_strand_limit: number | null = 4,
    verbose: boolean = false,
    threshold: number | null = 0.8,
    extract_options: InputPathType | null = null,
    wsize: number | null = 11,
    wsizemm: number | null = null,
    polvw_size: number | null = 5,
    polv_len: number | null = 3,
