...
function volume_extrema(
    ...
    const params = volume_extrema_params(volume_out, roi_volume, subvolume, volume_in, distance, presmooth, threshold, sum_subvols, consolidate_mode, only_maxima, only_minima)
